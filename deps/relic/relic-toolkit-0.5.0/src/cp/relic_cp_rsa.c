...
int cp_rsa_gen_basic(rlc_rsa_t pub, rlc_rsa_t prv, int bits) {
	bn_t t, r;
	int result = STS_OK;
...
int cp_rsa_gen_quick(rlc_rsa_t pub, rlc_rsa_t prv, int bits) {
	bn_t t, r;
	int result = STS_OK;
...
int cp_rsa_enc(uint8_t *out, int *out_len, uint8_t *in, int in_len, rlc_rsa_t pub) {
	bn_t m, eb;
...
int cp_rsa_dec_basic(uint8_t *out, int *out_len, uint8_t *in, int in_len, rlc_rsa_t prv) {
	bn_t m, eb;
	int size, pad_len, result = STS_OK;
...
int cp_rsa_dec_quick(uint8_t *out, int *out_len, uint8_t *in, int in_len, rlc_rsa_t prv) {
	bn_t m, eb;
	int size, pad_len, result = STS_OK;
...
int cp_rsa_sig_basic(uint8_t *sig, int *sig_len, uint8_t *msg, int msg_len, int hash, rlc_rsa_t prv) {
	bn_t m, eb;
	int size, pad_len, result = STS_OK;
	uint8_t h[MD_LEN];
...
int cp_rsa_sig_quick(uint8_t *sig, int *sig_len, uint8_t *msg, int msg_len, int hash, rlc_rsa_t prv) {
	bn_t m, eb;
...
int cp_rsa_ver(uint8_t *sig, int sig_len, uint8_t *msg, int msg_len, int hash, rlc_rsa_t pub) {
	bn_t m, eb;
